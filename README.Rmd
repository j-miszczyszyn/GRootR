...
The methodology implemented in GRootR was developed during research on root system variability in Scots pine forests using multichannel ground-penetrating radar. The following publication presents the scientific background and first results obtained with the approach used in this package:

> Tymińska-Czabańska, L., Polak, M., Miszczyszyn, J., Dąbrowski, M., & Socha, J. (2025). First application of multichannel GPR for root system variability analysis in Scots pine forests. *Ecological Indicators*, 179, 114282. [doi:10.1016/j.ecolind.2025.114282](https://doi.org/10.1016/j.ecolind.2025.114282)

If you use GRootR in your work, please cite both the article and the package:
```r
citation("GRootR")
```
## Acknowledgments
