...
The methodology implemented in GRootR was developed during research on
root system variability in Scots pine forests using multichannel
ground-penetrating radar. The following publication presents the
scientific background and first results obtained with the approach used
in this package:
...
If you use GRootR in your work, please cite both the article and the
package:
